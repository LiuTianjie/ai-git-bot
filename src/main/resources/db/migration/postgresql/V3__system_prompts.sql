...
CREATE TABLE IF NOT EXISTS system_prompts (
    ...
    review_system_prompt TEXT NOT NULL,
    issue_agent_system_prompt TEXT NOT NULL,
...
$review_prompt$, $agent_prompt$You are an autonomous software implementation agent. Analyze the Gitea issue and produce code changes using tool requests.
## Output Format
